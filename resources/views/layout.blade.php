...
<body class="bg-gray-100 font-sans antialiased">
    ...
    <a href="{{ route('scholarships.index') }}" class="flex items-center px-4 py-3 rounded hover:bg-slate-800 {{ request()->routeIs('scholarships.index') ? 'bg-slate-800 text-blue-400' : '' }}">
        <i class="fas fa-home w-6"></i> Dashboard
    </a>
    
    @auth
        <a href="{{ route('scholarships.create') }}" class="flex items-center px-4 py-3 rounded hover:bg-slate-800 {{ request()->routeIs('scholarships.create') ? 'bg-slate-800 text-blue-400' : '' }}">
            <i class="fas fa-plus-circle w-6"></i> Add Scholarship
        </a>
        <a href="{{ route('scholarships.trash') }}" class="flex items-center px-4 py-3 rounded hover:bg-slate-800 {{ request()->routeIs('scholarships.trash') ? 'bg-slate-800 text-blue-400' : '' }}">
    ...
    <div class="flex items-center space-x-4">
        ...
        @else
            ...
            <a href="{{ route('register') }}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition shadow-sm">
                Register
            </a>
        @endauth
    </div>
